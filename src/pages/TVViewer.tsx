...
const TVViewer = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            setLoading(true);
            try {
                const [details, credits, similarShows] = await Promise.all([
                ...
                setInWatchlist(StorageService.isInWatchlist(tvId));
    ...
    return (
        <div className="tv-viewer">
            {/* Player Area */}
            <div className="tv-player-wrapper" ref={iframeContainerRef}>
                {backdropUrl && !playing && (
                    <img
                        src={backdropUrl}
                        alt={show.name}
                ...
                {!playing ? (
                    <div className="tv-splash" onClick={handlePlay}>
                ...
                <div className="tv-info-layout">
                    <div className="tv-info-main">
                        ...
                        <div className="tv-season-selector">
                            <label className="tv-season-label">Season</label>
                            <select
                        ...
                        <div className="tv-mobile-issues">
                            ...
                            <button
                                className="tv-action-btn"
                                onClick={() => openFeedback(show.name)}
                        ...
                        {cast.length > 0 && (
                            <div className="tv-cast-section animate-fade-in-up">
                                <h3 className="tv-cast-title">Top Cast</h3>
