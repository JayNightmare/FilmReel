        ...
        const fetchInitial = async () => {
            ...
            try {
                ...
                if (id === "popular") {
                    ...
                    fetched = await APIService.getPopularMovies(1);
                    ...
                    if (!isNaN(genreId)) {
                        const allGenres = await APIService.getGenres();
                        const genre = allGenres.find((g) => g.id === genreId);
                        setTitle(genre ? `${genre.name} Hits` : "Genre Movies");
                        fetched = await APIService.getMoviesByGenre(genreId, 1);
                    }
                }
    ...
    const loadMore = async () => {
        ...
        try {
            ...
            if (id === "popular" || id === "top_rated") {
                ...
                const genreId = parseInt(id, 10);
                if (!isNaN(genreId)) {
                    fetched = await APIService.getMoviesByGenre(genreId, page);
                }
            }
        ...
        <div className="category-page animate-in fade-in">
            <div className="category-header">
                ...
                <p className="category-description">
                    ...
                    Find your next favorite film and dive into the cinematic
                    experience.
                </p>
            </div>
            ...
            {movies.length === 0 && !loadingMore ? (
                <div className="category-empty">
                    No movies found in this category. Let's head back home!
                </div>
            ) : (
