...
export const Navbar = () => {
	...
	const updateNotif = notifications.find(
		(n) => n.id === "player-update-superembed",
	);
	...
	const dismissBanner = () => {
		...
		const updated = notifications.map((n) =>
			n.id === updateNotif.id ? { ...n, read: true } : n,
		);
		setNotifications(updated);
				...
				<div className="update-banner">
					<div className="container update-banner-inner">
						<div className="update-banner-content">
							<span className="material-symbols-outlined update-banner-icon">
								info
							</span>
							<div>
								<strong>
						...
						<button
							...
							className="btn btn-glass update-banner-close"
						>
							Dismiss
						</button>
					</div>
